# Fake-AP v1.0, Author: Evan Al Mahmud Irfan ථ (You Dont Became Coder by Just Changing the Credits)
# github: https://github.com/sacrobrent/Fakeap
trap 'printf "\n";stop;exit 1' 2
...
printf "                  \   \_ \`  -+-  \` _/   / \n"
printf "                   \`-       -+-       -\` \n"
printf "                            -+- \e[0m\e[1;77mCoded by: Evan Al Mahmud Irfan ථ\e[0m\n"
printf "\n"
